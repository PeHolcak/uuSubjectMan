...
let Calls = {
  ...
  subjectGet({subjectId}){
    ...
    return Calls.call("get", commandUri, {id: subjectId});
  },
  ...
  materialList(dtoIn){
    let commandUri = Calls.getCommandUri("material/list");
    return Calls.call("get", commandUri, dtoIn);
  },

  materialGet(dtoIn){
    let commandUri = Calls.getCommandUri("material/get");
    return Calls.call("get", commandUri, dtoIn);
  },

  materialDelete(dtoIn){
    let commandUri = Calls.getCommandUri("material/delete");
    return Calls.call("post", commandUri, dtoIn);
  },

  materialUpdate(dtoIn){
    let commandUri = Calls.getCommandUri("material/update");
    return Calls.call("post", commandUri, dtoIn);
  },

  materialCreate(dtoIn){
    let commandUri = Calls.getCommandUri("material/create");
    return Calls.call("post", commandUri, dtoIn);
  },
